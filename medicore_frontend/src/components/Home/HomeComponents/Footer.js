    ...
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:support@medicore.com">support@medicore.com</a>
            </li>
            <li>
              <a href="mailto:appointment@medicore.com">
                appointment@medicore.com
              </a>
            </li>
            <li>
      ...
      <div className="ft-copyright">
        ...
        <ul className="ft-social-links">
          <li>
            <a
              href="https://linkedin.com/in/medicore/"
              title="LinkedIn"
              target="_blank"
